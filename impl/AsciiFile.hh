...
class OutputAsciiTreeFile: public AsciiTree, public OutputTreeFile
{
 public:
  OutputAsciiTreeFile() = default;
...
class InputAsciiTreeFile: public AsciiTree, public InputTreeFile {
 public:
  InputAsciiTreeFile();
  void open(const std::string& s) override ;
  void close() override ;
  ...
  using InputTreeFile::read_variable;
