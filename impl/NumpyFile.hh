...
class OutputNumpyTreeFile: public NumpyTree, public OutputTreeFile
{
public:
  OutputNumpyTreeFile();
...
class InputNumpyTreeFile: public NumpyTree, public InputTreeFile
{
public:
  InputNumpyTreeFile();
  ...
  using InputTreeFile::read_variable; //call templated version
